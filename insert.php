...
if(isset($_POST['submit']))
{
	...
	$DOB=$_POST['DOB'];
	$Mobile=$_POST['Mobile'];
    $query="insert into registration(`Name`, `Fname`, `Address`, `Gender`, `State`, `District`, `City`, `pincode`, `Course`, `Email`, `Dob`, `MObileNo`)values('$Name','$Fname','$Address','$Gender','$State','$District','$City','$pincode','$Course','$Email','$DOB','$Mobile')";
...
<body bgcolor="	pink">
	<center>
		<fieldset>	
			<h2><b>ITI  STUDENT  REGISTRATION  FORM</b></h2>
